	...
	json := []byte(`
{
  "9780547928210": {
    ...
    "description": "The first volume of J. R. R. Tolkien’s epic adventure The Lord of the Rings, in which Frodo Baggins begins his perilous journey to destroy the One Ring.",
